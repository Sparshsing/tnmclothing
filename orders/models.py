...
class Order(models.Model):
    ...
    saleDate = models.DateField(blank=True)
    ...
    customerPaidShipping = models.DecimalField(max_digits=5, decimal_places=2, blank=True)
    trackingNumber = models.CharField(max_length=30, blank=True)
    productAvailability = models.CharField(max_length=20, blank=True)
