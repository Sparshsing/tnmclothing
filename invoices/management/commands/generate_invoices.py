...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            logger.exception('Error creating System generated invoices for ' + dates + '' + str(err))
        ...
        file1.close()
        logger.info('Invoices generated by system on ' + str(date.today()) + ' for ' + dates + ' count: ' + str(count))
